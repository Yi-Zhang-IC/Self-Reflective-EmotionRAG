...
retrival_method = "OriginalRAG"  # Combination of Context and Emotion
        ...
        for trial in range(1, 4):
            ...
            for qid in question_ids:
                ...
                try:
                    ...
                    print(f"[FATAL] Failed Q{qid} for {character}: {e}")
                    traceback.print_exc()
                    print(f"[FATAL] Stopping script due to unrecoverable failure on Q{qid} for {character} using {backend_name}.")
                    sys.exit(1)
