...
def log_to_jsonl(log_entry, log_file="outputs/NT_freeze/freeze_encoder_NT_Xent_loss.jsonl"):
        ...
        for batch in tqdm(train_loader, desc=f"Training Step {step + 1}", ncols=100):
            ...
            if (step + 1) % 10 == 0:
                ...
                if val_macro_precision > best_macro_precision:
                    ...
                    torch.save(model.projection_head.state_dict(), f"outputs/NT_freeze/best_projection_head_freeze_encoder.pt")
