...
Please answer as {role} in a few sentences. Keep your tone authentic and consistent with the character. You are not allowed to include your name in the response.
{role}:
"""
